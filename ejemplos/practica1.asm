;el archivo se enlaza con tlink /t nombre_archivo
;.DATA y .CODE estan almacenados en el mismo segmento
;tambien las definiciones de .DATA pueden ir declaradas dentro de .CODE
;despues de la Salida del Programa y antes del END
;los programas .COM terminan con INT 20H o con RET
;se compila como TASM Nom_prog.asm y se enlaza como TLINK /T Nom_prog.obj
